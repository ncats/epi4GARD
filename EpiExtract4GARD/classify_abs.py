...
def search_Pubmed_API(searchterm_list, maxResults): #returns a dictionary of {pmids:abstracts} 
...
def search_NCBI_API(searchterm_list, maxResults): #returns a dictionary of {pmids:abstracts} 
...
def search_EBI_API(searchterm_list,maxResults): #returns a dictionary of {pmids:abstracts}    
